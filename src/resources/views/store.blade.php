...
<div class="container">
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
            ...
            <form @if ($stepTwo) action="{{url('api/v1/user-disks')}}" method="POST" @else action="{{route('settings-create-storage-disks')}}" method="GET" @endif>
                <fieldset class="row">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group clearfix">
                            ...
                            @if ($stepTwo)
                                <a href="{{route('settings-create-storage-disks')}}" class="btn btn-default">Back</a>
                            @else
