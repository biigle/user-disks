<div class="col-xs-12">
    <div class="form-group @error('url') has-error @enderror">
        <label>URL</label>
        <input type="text" name="url" id="azure-url" class="form-control" value="{{old('url', $disk->options['url'] ?? '')}}" placeholder="https://account.blob.core.windows.net/container?sas...">
...
<div class="col-xs-12">
    <div class="form-group @error('name') has-error @enderror">
        ...
        <input type="text" name="name" id="azure-name" class="form-control" value="{{old('name', $disk->options['name'] ?? '')}}" placeholder="Azure Storage Account Name">
        @error('name')
            <p class="help-block">{{$message}}</p>
        @enderror
    </div>
...
<div class="col-xs-12">
    <div class="form-group @error('key') has-error @enderror">
        ...
        <input type="text" name="key" class="form-control" value="{{old('key', $disk->options['key'] ?? '')}}" placeholder="Azure Storage Account Key">
        @error('key')
            <p class="help-block">{{$message}}</p>
        @enderror
    </div>
...
<div class="col-xs-12">
    <div class="form-group @error('container') has-error @enderror">
        ...
        <input type="text" name="container" id="azure-container" class="form-control" value="{{old('container', $disk->options['container'] ?? '')}}" placeholder="Container Name">
        @error('container')
            <p class="help-block">{{$message}}</p>
        @enderror
    </div>
...
<div class="col-xs-12">
    <div class="form-group @error('endpoint') has-error @enderror">
        ...
        <input type="text" name="endpoint" id="azure-endpoint" class="form-control" value="{{old('endpoint', $disk->options['endpoint'] ?? '')}}" placeholder="https://account.blob.core.windows.net">
        @error('endpoint')
            <p class="help-block">{{$message}}</p>
        @enderror
    </div>
...
<div class="col-xs-12">
    <div class="form-group @error('sas_token') has-error @enderror">
        ...
        <input type="text" name="sas_token" id="azure-sas-token" class="form-control" value="{{old('sas_token', $disk->options['sas_token'] ?? '')}}" placeholder="?sv=...">
        @error('sas_token')
            <p class="help-block">{{$message}}</p>
        @enderror
    </div>
